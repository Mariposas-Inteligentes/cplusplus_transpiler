...
'''
    ...
    expected = [
        'START_MARKER', 'DEF', 'VAR_FUNC_NAME', 'OPEN_PARENTHESIS', 'VAR_FUNC_NAME', 'CLOSED_PARENTHESIS',
        'COLON', 'NEWLINE', 'INDENT', 'VAR_FUNC_NAME', 'ASSIGN', 'INT', 'NEWLINE', 'FOR', 'VAR_FUNC_NAME',
        'IN', 'VAR_FUNC_NAME', 'OPEN_PARENTHESIS', 'VAR_FUNC_NAME', 'CLOSED_PARENTHESIS', 'COLON', 'NEWLINE',
        'INDENT', 'VAR_FUNC_NAME', 'ASSIGN', 'OPEN_PARENTHESIS', 'MINUS', 'INT', 'CLOSED_PARENTHESIS', 'POWER',
        'VAR_FUNC_NAME', 'DIV', 'OPEN_PARENTHESIS', 'INT', 'MUL', 'VAR_FUNC_NAME', 'PLUS', 'INT', 'CLOSED_PARENTHESIS',
        'NEWLINE', 'VAR_FUNC_NAME', 'PLUS_EQUALS', 'VAR_FUNC_NAME', 'NEWLINE', 'DEDENT', 'VAR_FUNC_NAME', 'MUL_EQUALS',
        'INT', 'NEWLINE', 'RETURN', 'VAR_FUNC_NAME', 'NEWLINE', 'DEDENT', 'VAR_FUNC_NAME', 'ASSIGN', 'INT', 'NEWLINE',
        'VAR_FUNC_NAME', 'ASSIGN', 'VAR_FUNC_NAME', 'OPEN_PARENTHESIS', 'VAR_FUNC_NAME', 'CLOSED_PARENTHESIS', 'NEWLINE',
        'PRINT', 'OPEN_PARENTHESIS', 'STRING', 'PLUS', 'VAR_FUNC_NAME', 'OPEN_PARENTHESIS', 'VAR_FUNC_NAME', 'CLOSED_PARENTHESIS',
        'CLOSED_PARENTHESIS', 'NEWLINE', 'NEWLINE', 'END_MARKER'
    ]
...
'''
    ...
    expected = [
        'START_MARKER', 'CLASS', 'VAR_FUNC_NAME', 'COLON', 'NEWLINE', 'INDENT', 'DEF', 'VAR_FUNC_NAME', 
        ...
        'STRING', 'COMMA', 'VAR_FUNC_NAME', 'CLOSED_PARENTHESIS', 'NEWLINE', 'DEDENT', 'NEWLINE', 'END_MARKER'
    ]
...
def test_correct_pass_token(lexer):
    ...
    expected = ['START_MARKER', 'PASS', 'NEWLINE', 'END_MARKER']
...
'''
    ...
    expected = [
        'START_MARKER', 'DEF', 'VAR_FUNC_NAME', 'OPEN_PARENTHESIS', 'VAR_FUNC_NAME', 'CLOSED_PARENTHESIS',
        'COLON', 'NEWLINE', 'INDENT', 'IF', 'VAR_FUNC_NAME', 'VAR_FUNC_NAME', 'NONE', 'COLON', 'NEWLINE',
        'INDENT', 'VAR_FUNC_NAME', 'DIV_EQUALS', 'INT', 'NEWLINE', 'VAR_FUNC_NAME', 'MUL_EQUALS', 'INT',
        'NEWLINE', 'DEDENT', 'DEDENT', 'NEWLINE', 'END_MARKER'
    ]
...
'''
    ...
    expected = [
        'START_MARKER', 'WHILE', 'TRUE', 'COLON', 'NEWLINE', 'INDENT', 'IF', 'VAR_FUNC_NAME',
        'LESS', 'INT', 'AND', 'VAR_FUNC_NAME', 'MORE', 'INT', 'COLON', 'NEWLINE', 'INDENT',
        'CONTINUE', 'NEWLINE', 'DEDENT', 'ELSE', 'COLON', 'NEWLINE', 'INDENT', 'BREAK',
        'NEWLINE', 'DEDENT', 'VAR_FUNC_NAME', 'MINUS_EQUALS', 'INT', 'NEWLINE', 'DEDENT',
